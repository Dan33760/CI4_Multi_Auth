                    ...
                    <div class="col-md-6 col-lg-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Boutique : <?= $panier->DESIGNATION_BOUTIQUE; ?></p>
                                      ...
                                      <?php endif; ?>
                                        <a href="<?= base_url('client/panier_detail/'.$panier->ID_BOUTIQUE.'/'.$panier->ID_PANIER); ?>" class="card-link btn btn-danger btn-sm"><i class='bx bx-cart-alt'></i></a>
                                </div>
                            </div>
                        </div>
                <?php endforeach; ?>
