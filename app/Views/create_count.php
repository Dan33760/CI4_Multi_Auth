        ...
        <div class="authentication">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url('/create_count') ?>" method="post">
                    <div class="row">
                            
                            <div class="mb-3 col-md-6">
                                <label for="firstName" class="form-label">Nom</label>
                                <input class="form-control form-control-sm" type="text" id="firstName" name="nom" value="" autofocus/>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="lastName" class="form-label">Post Nom</label>
                                <input class="form-control form-control-sm" type="text" name="postnom" id="postnom" value="" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control form-control-sm" type="email" id="email" name="email" value="" />
                            </div>
                            <div class="mb-3 col-md-6">
